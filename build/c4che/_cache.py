...
CXXFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-PPrPZj/python2.7-2.7.15=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-fwrapv', '-fdebug-prefix-map=/build/python2.7-PPrPZj/python2.7-2.7.15=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['wireless', 'naming', 'stats', 'socket', 'realtime', 'udp-client-server', 'udp', 'matrix-topology', 'routing', 'error-model', 'energy', 'tcp', 'tutorial', 'ipv6']
...
NS3_EXECUTABLE_PATH = ['/home/hrezae2/Superways/build/src/emu', '/home/hrezae2/Superways/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/hrezae2/Superways/build']
...
cfg_files = ['/home/hrezae2/Superways/build/ns3/config-store-config.h', '/home/hrezae2/Superways/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
